...
*/
  tags = "${merge(map("Name", "${var.name}-rt-private-${element(var.azs, count.index)}"), var.tags)}"
}
...
resource "aws_subnet" "private" {
  ...
  */
  ...
  tags = "${merge(map("Name", "${var.name}-subnet-private-${element(var.azs, count.index)}"), var.tags)}"
}
...
*/
  tags = "${merge(map("Name", "${var.name}-subnet-public-${element(var.azs, count.index)}"), var.tags)}"
